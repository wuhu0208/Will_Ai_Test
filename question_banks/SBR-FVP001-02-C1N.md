...
按本 PDF 第 19 印刷页的通用安全要求，分别说明液压装置操作人员和液压/气动机械设备操作维护人员的资格要求，以及检查、拆卸、重新启动、运行中接触、产品解体改造和大修分别必须遵守的控制。

### Standard Answer

液压装置应由具备丰富知识和专业经验的人员操作。液压/气动机械设备和装置的操作及维护保养，应由具备丰富知识和经验的人员负责。检查或拆卸前，应对被驱动物体采取防坠落和防误动作措施；拆卸时切断压力源和电源，确认油压/气压回路为零压，并等待刚停机设备完全冷却。重新启动前检查螺栓等连接部位是否异常。运行中严禁接触工件、配件和分体式夹钳。不得擅自解体或改造产品；解体大修应委托厂家。

### Scoring Standard

- P1 [6]: 正确限定液压装置由具备丰富知识和专业经验的人员操作。
- P2 [6]: 正确限定液压/气动机械设备和装置由具备丰富知识和经验的人员操作及维护保养。
- P3 [12]: 正确说明对被驱动物体采取防坠落措施。
- P4 [12]: 正确说明采取防止误动作的措施。
- P5 [10]: 正确说明拆卸前切断压力源。
- P6 [10]: 正确说明拆卸前切断电源。
- P7 [10]: 正确说明确认油压/气压回路为零压。
- P8 [8]: 正确说明等待设备完全冷却。
- P9 [8]: 正确说明重新启动前检查螺栓等连接部位。
- P10 [8]: 正确说明运行中不得接触工件、配件和夹钳。
- P11 [5]: 正确说明不得擅自解体或改造。
- P12 [5]: 正确说明解体大修应委托厂家。
...
- 允许缺乏丰富知识或专业经验的人员操作液压装置。
- 允许缺乏丰富知识或经验的人员操作、维护液压/气动机械设备和装置。
- 只停泵而不切断电源或确认零压。
- 在设备仍热时拆卸。
- 允许运行中接触工件或夹钳。
- 允许用户擅自解体、改造或自行进行解体大修。
...
- Local scope path: 本 PDF 第19印刷页的两类人员资质、隔离、零压、冷却、重启、接触、解体改造和厂家大修要求
- Evidence type: TEXT + DRAWING
- Evidence: 操作与保养页分别规定液压装置操作人员须具备丰富知识和专业经验，液压/气动机械设备操作维护人员须具备丰富知识和经验；同页还规定安全隔离、零压和冷却确认、重启检查、运行中禁触、禁止擅自解体改造及厂家解体大修。
