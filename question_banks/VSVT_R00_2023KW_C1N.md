...
安装前必须清除油口和管路内的切屑、密封带碎片等异物；缠密封带时从管端保留 1～2 个螺纹牙，不让碎片进入回路；使用适当且清洁的 ISO VG32 液压油。回路异物或残留密封带头会造成漏油或动作不良。
...
- P2 [13]: 清除管路内的切屑等异物。
- P3 [13]: 防止密封带碎片进入回路。
- P4 [13]: 密封带从管端保留 1～2 个螺纹牙。
- P5 [12]: 工作油采用 ISO VG32。
- P6 [12]: 工作油必须保持清洁。
- P7 [12]: 回路异物可能造成漏油。
- P8 [12]: 回路异物可能造成动作不良。
...
- Evidence type: CAUTION
- Evidence: 配管说明要求清洁端口、密封带留 1～2 牙并使用合适的 ISO VG32 油，警示异物导致通用漏油和动作不良；来源不区分内部泄漏与外部泄漏。
