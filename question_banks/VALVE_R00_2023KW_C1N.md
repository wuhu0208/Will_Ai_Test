...
- P1 [7]: JSS 基准压力代码 `2`～`7` 对应 2～7 MPa。
- P2 [7]: JSS `02` 对应 2.5 cm³。
- P3 [7]: JSS `05` 对应 5.0 cm³。
- P4 [7]: JSS `10` 对应 10 cm³。
- P5 [7]: JSS `H` 表示水平安装。
- P6 [7]: JSS `V` 表示垂直安装。
- P7 [7]: JSS `C` 表示 G 螺纹外配管。
- P8 [7]: JSS `S` 表示 Rc 螺纹外配管。
- P9 [7]: JSS `G` 表示板式连接。
- P10 [7]: JSS `GC` 表示板式加 G 螺纹外配管。
- P11 [6]: JSS `GS` 表示板式加 Rc 螺纹外配管。
- P12 [6]: BU 代码 `2` 表示 2.2 倍。
- P13 [6]: BU 代码 `3` 表示 3.0 倍。
- P14 [6]: BU 代码 `6` 表示 6.0 倍。
- P15 [6]: BU 型号末尾括号填写一次侧供给压力。
...
- P7 [6]: 禁止擅自改造。
- P8 [6]: 检查并紧固配管连接。
- P9 [6]: 检查安装螺栓、螺母、挡圈和夹具。
- P10 [6]: 检查液压油老化。
- P11 [6]: 检查异常声音。
- P12 [6]: 检查异常动作。
- P13 [6]: 自动接头带入空气时应定期排气。
- P14 [6]: 保持接触基准面和圆柱面清洁。
- P15 [6]: 产品应存放在阴凉干燥处。
- P16 [6]: 维修应由制造商或授权方处理。
